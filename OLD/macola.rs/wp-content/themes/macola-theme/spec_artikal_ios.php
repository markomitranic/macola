 <?php 
/*
Template Name: Specijanli artikl iOS Template
*/
...
<hr>
			...
			<div class="beige grid4">
				<div class="row-fluid">
					<div class="span3">
						<div class="grid4-image-container centertag">
				...
				<div class="row-fluid">
					<div class="span3 grid4-heading centertag">
				...
				<div class="row-fluid">
					<div class="span3 grid4-description centertag">
						<div class="grid4-description">
							<?php the_field('content1'); ?>
						</div>
					</div>
					<div class="span3">
						<div class="grid4-description centertag">
					...
					<div class="span6 square-span">
						...
						<div class="square-block">
							...
							<div class="square-text">
								...
								<p>
									<a href="http://www.macola.rs/dodaci/?articleCat=zastite&articleDev=ipad-air-2&articlePro=">Zaštite ></a>
								</p>
								<p>
									<a href="http://www.macola.rs/dodaci/?articleCat=slusalice&articleDev=ipad-air-2&articlePro=">Slušalice ></a>
								</p>
								<p>
									<a href="http://www.macola.rs/dodaci/?articleCat=adapteri_kablovi&articleDev=ipad-air-2&articlePro=">Kablovi ></a>
								</p>
								<p>
									<a href="http://www.macola.rs/dodaci/?articleCat=zvucnici&articleDev=ipad-air-2&articlePro=">Zvučnici ></a>
								</p>
								<p>
									<a href="http://www.macola.rs/dodaci/?articleCat=ostalo&articleDev=ipad-air-2&articlePro=">Ostalo ></a>
								</p>
							</div>
						</div>
					</div>
