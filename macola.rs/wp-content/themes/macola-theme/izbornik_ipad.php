<?php 
/*
Template Name: Izbornik iPad Template
*/
...
<hr>
			...
			<div class="row-fluid hero">
				<div class="span6 image">
					<img src="<?php echo site_url(); ?>/wp-content/themes/macola-theme/img/izbornik/hero_ios.png">
				</div>								
			</div>

<section class="padding-content izbornikGrid">
<?php 
$args = array( 'posts_per_page' => 6, 'orderby' => 'date', 'order' => 'DESC', 'category__in' => array(24));
