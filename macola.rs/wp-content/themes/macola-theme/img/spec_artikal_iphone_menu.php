<?php 
/*
Template Name: Izbornik iPhone MENI
*/
...
<hr>
			...
			<div class="span6"><a href="<?php echo site_url(); ?>/iphone-6s/"><img src="<?php echo site_url(); ?>/wp-content/themes/macola-theme/img/iphone/iphone6s_menu.png" alt=""></a></div>
			<div class="span6"><a href="<?php echo site_url(); ?>/iphone-6s-plus/"><img src="<?php echo site_url(); ?>/wp-content/themes/macola-theme/img/iphone/iphone6splus_menu.png" alt=""></a></div>
			<div class="span6 iphonedodaci"><img src="<?php echo site_url(); ?>/wp-content/themes/macola-theme/img/iphone/iphoneaccs_menu.png" alt=""></div>
 			<div class="span6 iphonedodaci"><div class="iphonedodaci2">
...
<ul>
	...
	<li><a href="https://macola.rs/dodaci/?articleCat=ostalo&articleDev=iphone5&articlePro=">Ostalo, postolja, nosači ></a></li>
			...
			<div class="span6"><a href="<?php echo site_url(); ?>/iphone-5c-simfree/"><img src="<?php echo site_url(); ?>/wp-content/themes/macola-theme/img/iphone/iphone5c_menu.png" alt=""></a></div>
			<div class="span6"><a href="<?php echo site_url(); ?>/iphone-5s-simfree/"><img src="<?php echo site_url(); ?>/wp-content/themes/macola-theme/img/iphone/iphone5s_menu.png" alt=""></a></div>
 			</div>
